...
<section class="breadcrumb__area">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-10 order-0 order-lg-2">
                        ...
                        <div style="margin-top: 10px;">
                            @if($dataartikel->berkas && file_exists(public_path('storage/' . $dataartikel->berkas)))
                                <!-- Menampilkan PDF dari storage -->
                                <iframe src="{{ asset('storage/' . $dataartikel->berkas) }}"
                                        style="width: 100%; height: 400px; border: 1px solid #ccc;"
                                        frameborder="0"
                                        loading="lazy"></iframe>
                            @elseif($dataartikel->berkas)
                                <!-- Menampilkan PDF dari path luar storage -->
                                <iframe src="{{ asset($dataartikel->berkas) }}"
                                        style="width: 100%; height: 400px; border: 1px solid #ccc;"
                                        frameborder="0"
                                        loading="lazy"></iframe>
                            @else
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-six">
                            <div class="section__title mb-10">
                                ...
                                <h2 class="title">{{$dataartikel->judul}}</h2>
                            </div>

                       <div class="about__content-bottom-two">
    @if($dataartikel->berkas && file_exists(public_path('storage/' . $dataartikel->berkas)))
        <!-- Tombol download hanya muncul jika file ada -->
        <a href="{{ asset('storage/' . $dataartikel->berkas) }}" class="tg-btn tg-btn-seven" download>
    ...
    @elseif($dataartikel->berkas)
        ...
        <a href="{{ asset($dataartikel->berkas) }}" class="tg-btn tg-btn-seven" download>
            Download <img src="/assets/assets/img/icons/right_arrow.svg" alt="" class="injectable">
        </a>
