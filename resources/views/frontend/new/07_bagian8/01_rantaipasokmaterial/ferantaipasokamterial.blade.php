...
<div class="col-12 mb-4">
    <div class="w-100 d-flex flex-wrap align-items-center justify-content-between gap-3 p-4"
        ...
        <div class="d-flex align-items-center px-3 py-2 rounded"
            ...
            <input type="text"
                id="searchMaterial"
                placeholder="Cari Supplier Material ?"
            ...
            <form method="GET" id="filterForm" style="flex:1;">
                <select name="informasirantaipasok_id"
                    ...
                    @foreach($kategori as $k)
                        <option value="{{ $k->id }}"
                            {{ ($informasirantaipasok_id == $k->id) ? 'selected' : '' }}>
                            {{ $k->namaperusahaan }}
                        </option>
                    @endforeach
                </select>
...
<script>
    ...
    <th style="text-align: center;">
        <i class="bi bi-list-ol text-primary"></i> No
    </th>

    <th style="text-align: center;" class="product__name">
        <i class="bi bi-box text-primary"></i> Material
    </th>

    <th style="text-align: center;" class="product__name">
        <i class="bi bi-box text-primary"></i> Foto/Gambar
    </th>

    <th style="text-align: center;">
        <i class="bi bi-bounding-box text-primary"></i> Satuan
    </th>

    <th style="text-align: center;">
        <i class="bi bi-cash-stack text-primary"></i> Harga (Rp)
    </th>
    ...
    <th style="text-align: center;">
        <i class="bi bi-archive text-primary"></i> Ketersediaan
    </th>

    <th style="text-align: center;">
        <i class="bi bi-card-text text-primary"></i> Ket
    </th>

    <th style="text-align: center;">
        <i class="bi bi-card-text text-primary"></i> No Telp
    </th>
</tr>
    ...
    <div style="margin-top: 10px;">
        ...
        @if(file_exists(public_path($gambar)))
            <img src="{{ asset($gambar) }}"
                 ...
                 loading="lazy">
        @else
            <p style="font-size: 12px;">Gambar tidak ditemukan</p>
        @endif
            ...
            <td style="text-align: center;">
    @php
        $status = strtolower($item->ketersediaan);
    @endphp
...
function searchMaterial() {
    ...
    fetch(`/rantaipasokmaterial?search=${encodeURIComponent(input)}`)
