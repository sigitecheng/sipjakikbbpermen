            ...
            <div class="col-12 mb-4">
                <div class="w-100 d-flex flex-wrap align-items-center justify-content-between gap-3 p-4"
                    ...
                    <div class="d-flex align-items-center px-3 py-2 rounded"
                        ...
                        <input type="text" id="searchMaterial" placeholder="Cari Supplier Peralatan ?"
                    ...
                    <div class="d-flex align-items-center gap-2" style="flex: 1; min-width: 280px;">
                        <label style="font-family: 'Poppins'; font-weight: 600; white-space: nowrap;">
                            Pilih CV/PT :
                        </label>
...
<script>
    ...
    <thead>
        <tr>
            ...
            <th style="text-align: center;" class="product__name">
                <i class="bi bi-box"></i> Foto/Gambar
            </th>

            <th style="text-align: center;">
                <i class="bi bi-bounding-box"></i> Satuan
            </th>

            <th style="text-align: center;">
                <i class="bi bi-cash-stack"></i> Harga (Rp)
            </th>
            ...
            <th style="text-align: center;">
                <i class="bi bi-archive"></i> Ketersediaan
            </th>

            <th style="text-align: center;">
                <i class="bi bi-card-text"></i> Ket
            </th>

            <th style="text-align: center;">
                <i class="bi bi-card-text"></i> No Telp
            </th>
        </tr>
    </thead>
...
function searchMaterial() {
    ...
    fetch(`/rantaipasokperalatan?search=${encodeURIComponent(input)}`)
