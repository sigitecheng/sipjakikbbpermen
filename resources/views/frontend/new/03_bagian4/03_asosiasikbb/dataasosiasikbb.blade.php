...
">
    ...
    <thead>
        <tr>
            ...
            <th style="text-align: center;">Jumlah BUJK Konsultasi Konstruksi</th>
    ...
    <tbody id="tableBody">
        ...
        <tr>
            ...
            <td>{{ $item->pic ?? '-' }}</td>
           <td style="text-align: center;"><span class="badge bg-primary">{{ $item->bujkkonsultan_count }}</span></td>
           <td style="text-align: center;"><span class="badge bg-success">{{ $item->bujkkontraktor_count }}</span></td>
        </tr>
        @empty
        <tr>
            <td colspan="7">
...
function searchMaterial() {
    ...
    fetch(`/dataasosiasi?search=${encodeURIComponent(input)}`)
