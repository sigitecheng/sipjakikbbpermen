...
<div class="table-responsive">
    ...
    <th style="min-width:220px; max-width:220px;">
        <i class="bi bi-person-badge me-1 text-primary"></i>
        Nama Lengkap
    </th>

    <th style="text-align:center; min-width:200px; max-width:200px;">
        <i class="bi bi-geo-alt me-1 text-primary"></i>
        Tempat, Tgl Lahir
    </th>

    <th style="text-align:center; min-width:140px; max-width:140px;">
    ...
    <th style="min-width:320px; max-width:320px;">
    ...
    @forelse($data as $item)
        <tr>
            ...
            <td style="text-align:center;">
               {{ $item->ttl
    ? \Carbon\Carbon::parse($item->ttl)->locale('id')->isoFormat('DD MMMM YYYY')
    : '-'
}}
            </td>
...
function searchMaterial() {
    ...
    fetch(`/datajakontkkkbb?search=${encodeURIComponent(input)}`)
