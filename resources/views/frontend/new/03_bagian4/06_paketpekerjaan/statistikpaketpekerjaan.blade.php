<style>
    .statistik-nav-wrapper {
    margin-bottom: 100px; /* ✅ sesuai permintaan */
...
/* tombol total biar sedikit beda */
.statistik-total {
    font-weight: 600;
...
<div class="container statistik-nav-wrapper" >
...
{{-- @include('frontend.A00_new.01_halamanutama.newjudul') --}}
    ...
    <div class="statistik-nav" style="margin-bottom:50px;">
        <button class="button-modern statistik-total">
            <i class="bi bi-briefcase-fill me-2"></i>
            Jumlah Paket {{ $data_totalpekerjaan }}
        </button>
        ...
        <button class="button-modern statistik-btn" data-target="statistik4">
            <i class="bi bi-calendar2-week-fill me-2"></i> Tahun
        </button>
    ...
    <button type="button" class="btn btn-outline-primary"
        ...
        <i class="bi bi-calendar3 me-2"></i> Lihat Jumlah Data Jenis Pekerjaan
    </button>
</div>
