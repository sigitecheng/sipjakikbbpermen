    ...
    <div class="col-lg-6 col-md-10 order-0 order-lg-2">
        <div class="about__img-six">
            <div style="margin-top:10px;">
                @if($datashow->foto && file_exists(public_path('storage/' . $datashow->foto)))
                    <img src="{{ asset('storage/' . $datashow->foto) }}"
                         alt="Foto Kegiatan"
                         style="
                            width:100%;
                            max-height:420px;
                         ...
                         "
                         loading="lazy">
                @elseif($datashow->foto)
                    <img src="{{ asset($datashow->foto) }}"
                         alt="Foto Kegiatan"
                         style="
                            width:100%;
                            max-height:420px;
    ...
    <div class="col-lg-6">
        <div class="about__content-six">
            ...
            <div class="section__title mb-20">
                <h2 class="title">
                    {{ $datashow->namakegiatan ?? 'Nama kegiatan belum diisi' }}
                </h2>
            </div>
            ...
            <ul style="font-size:15px; line-height:1.9;">
                {{-- <li>
                    ...
                    {{ optional($datashow->kategoripelatihan)->kategoripelatihan ?? '-' }}
                </li> --}}

                <li>
                    <i class="bi bi-building text-primary me-2"></i>
                    <strong>Asosiasi:</strong>
                    {{ optional($datashow->asosiasimasjaki)->namaasosiasi ?? '-' }}
                </li>

                <li>
                    <i class="bi bi-geo-alt text-primary me-2"></i>
                    <strong>Lokasi:</strong> {{ $datashow->lokasi ?? '-' }}
                </li>

                <li>
                    <i class="bi bi-people text-primary me-2"></i>
                    <strong>Jumlah Peserta:</strong> {{ $datashow->jumlahpeserta ?? 0 }} Orang
                </li>

                <li>
                    <i class="bi bi-calendar-check text-primary me-2"></i>
                    <strong>Pelaksanaan:</strong>
                    {{ $datashow->waktupelaksanaan
                        ? \Carbon\Carbon::parse($datashow->waktupelaksanaan)->translatedFormat('d F Y')
                        : '-' }}
                </li>
                ...
                <li>
                    ...
                    {{ $datashow->penutupan
                        ? \Carbon\Carbon::parse($datashow->penutupan)->translatedFormat('d F Y')
                        : '-' }}
                </li>
            </ul>
            ...
            <div class="mt-3">
                ...
                <p style="text-align:justify; font-size:14px;">
                    {!! nl2br(e($datashow->isiagenda ?? 'Agenda belum diisi')) !!}
                </p>
            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        ...
                        @if($item->foto && file_exists(public_path('storage/' . $item->foto)))
                                <div class="preview-image">
                                    <img src="{{ asset('storage/' . $item->foto) }}" alt="Foto Dokumen">
                                </div>
                            @elseif($item->foto)
                                <div class="preview-image">
                                    <img src="{{ asset($item->foto) }}" alt="Foto Dokumen">
                                </div>
                            @else
                                <p class="text-muted fst-italic">Data belum diupdate</p>
                            @endif
                                </a>
                       ...
                       <a href="{{ route('showagendaskkkbb', $item->namakegiatan) }}" class="tg-btn tg-btn-seven">
                                Lihat Agenda SKK <img src="/assets/assets/img/icons/right_arrow.svg" alt="" class="injectable">
                            </a>
