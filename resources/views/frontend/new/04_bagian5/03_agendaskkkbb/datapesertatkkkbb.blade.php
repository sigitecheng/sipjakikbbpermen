...
<div class="col-12 mb-4">
    <div class="w-100 d-flex flex-wrap align-items-center justify-content-between gap-3 p-4"
        ...
        <div class="d-flex align-items-center px-3 py-2 rounded"
            ...
            <input type="text"
                id="searchMaterial"
                placeholder="Cari Agenda Sertifikasi ?"
...
<script>
    ...
    <thead>
        <tr style="background:#f8f9fa;">
            <th style="text-align:center; font-weight:600; color:#0d6efd;">
                <i class="bi bi-list-ol me-1 text-primary"></i>
                No
            </th>

            <th style="text-align:center; font-weight:600; color:#0d6efd;" class="product__name">
                <i class="bi bi-journal-text me-1 text-primary"></i>
                Nama Kegiatan
            </th>

            <th style="text-align:center; font-weight:600; color:#0d6efd;" class="product__quantity">
            ...
            <th style="text-align:center; font-weight:600; color:#0d6efd;" class="product__price">
    ...
    <tbody id="tableBody">
        @forelse($data as $item)
            <tr>
                ...
                <td class="product__quantity" style="text-align:center;">
                    {{ $item->jumlahpeserta ?? 0 }}
                </td>

                <td class="product__price" style="text-align:center;">
                ...
                <td style="text-align:center;">
                    <a href="{{ route('lihatdaftarpesertatkkkbb', $item->namakegiatan) }}"
                       class="btn btn-sm btn-primary d-inline-flex align-items-center gap-1">
                        <i class="bi bi-people-fill"></i> Lihat
                    </a>
                </td>
            </tr>
        @empty
            <tr>
                <td colspan="6">
                    ...
                    ">
                        <i class="bi bi-folder-x me-1" style="font-size:20px; color:#dc3545;"></i>
...
function searchMaterial() {
    ...
    fetch(`/datapersetatkkkbb?search=${encodeURIComponent(input)}`)
