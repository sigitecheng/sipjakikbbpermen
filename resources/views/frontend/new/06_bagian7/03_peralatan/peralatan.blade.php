...
<script>
    ...
    ">
        <i class="bi bi-list-ol me-1 text-primary"></i> No
    </th>
    ...
    <th style="
        ...
        vertical-align:middle;
    " class="product__name">
        <i class="bi bi-card-text me-1 text-primary"></i> Uraian
    </th>
    ...
    " class="product__quantity">
        <i class="bi bi-bounding-box me-1 text-primary"></i> Satuan
    </th>
    ...
    " class="product__price">
        <i class="bi bi-cash-stack me-1 text-primary"></i> Rp.
    </th>
    ...
    <th style="
        ...
        vertical-align:middle;
    " class="product__price">
        <i class="bi bi-bar-chart-fill me-1 text-primary"></i> Besaran
    </th>
</tr>
