                ...
                <tr>
                    ...
                    <td>
                        <div class="button-container">
                            <a href="/datajakon/fesbulampiran2/{{$item->judul}}" class="iconhover" title="Lihat Data">
        ...
        <div class="div">
            <a href="/datajakon/fesbulampiran3" style="background: inherit;">
                <button class="badge-lampiran" style="border: none; cursor: pointer;">
                    <i class="bi bi-file-earmark-text-fill" style="margin-right: 5px;"></i>Lampiran 3
                </button>
            </a>
