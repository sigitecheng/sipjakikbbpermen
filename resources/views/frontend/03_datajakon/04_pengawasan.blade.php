...
">
    ...
    >
      Pengawasan Dan Tertib Jasa Konstruksi
    </h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:150px;">BANGUNAN GEDUNG</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ $item->pengawasanlokasi->kota }}</td>
                    <td style="text-align:center;">{{ $item->pengawasanbangunangedung->bangunan }}</td>
                    <td style="text-align:center;">{{ $item->penanggungjawabteknis->nama_lengkap }}</td>
                    <td style="text-align:center;">{{ $item->pengawasanstatus->status }}</td>
                    <td style="text-align:center;">{{ $item->pengawasantindakan->tindakan }}</td>
