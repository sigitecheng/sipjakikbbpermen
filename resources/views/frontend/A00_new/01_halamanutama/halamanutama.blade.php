...
<head>
    ...
    <title>{{$title}}</title>
    <meta name="description" content="SIPJAKI Kabupaten Bandung Barat">
                        ...
                        <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                            <ul class="navigation">
                                ...
                                <li class="menu-item-has-children"><a href="#">Kelembagaan</a>
                                    <ul class="sub-menu">
                                        <li><a href="#">Profil Jakon DPUTR</a></li>
                                ...
                                <li class="menu-item-has-children"><a href="#">Pembinaan</a>
                                    <ul class="sub-menu">
                                        <li><a href="#">Agenda Pelatihan</a></li>
                                        <li><a href="#">Peserta Pelatihan</a></li>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children"><a href="#">Tertib Jasa Konstruksi</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="#">Tertib Jakon Penyelenggaraan</a></li>
                                            </ul>
                                        </li>
                                ...
                                <li class="menu-item-has-children"><a href="#">AHSP</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item-has-children"><a href="#">HSP Konstruksi Umum</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">DIV I Persiapan Pekerjaan</a></li>
                                                <li><a href="#">DIV II Pekerjaan Struktur </a></li>
                                                <li><a href="#">DIV III Pekerjaan Arsitektur </a></li>
                                                <li><a href="#">DIV IV Pekerjaan Lansekap </a></li>
                                        ...
                                        <li class="menu-item-has-children"><a href="#">Rantai Pasok</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Material Bangunan</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="slider__content">
                                ...
                                <a href="/#" class="tg-btn tg-btn-four">Kontak Kami</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-lg-6">
             ...
             style="height:48px; width:auto; object-fit:contain;">
                            ...
                            {{-- <div class="footer__social footer__social-four">
                                <ul class="list-wrap">
                                    ...
                                    <li><a href="https://www.instagram.com/" target="_blank"><img src="/assets/assets/img/icons/instagram.svg" alt="" class="injectable"></a></li>
                                    <li><a href="https://www.pinterest.com/" target="_blank"><img src="/assets/assets/img/icons/pinterest.svg" alt="" class="injectable"></a></li>
                                    <li><a href="https://www.youtube.com/" target="_blank"><img src="/assets/assets/img/icons/youtube.svg" alt="" class="injectable"></a></li>
                                </ul>
                            </div> --}}
                        </div>
                    </div>
    ...
    <div class="footer__widget">
        ...
        {{-- <div class="footer__shape-wrap-four">
            <img src="/assets/assets/img/images/h5_footer_shape01.svg" alt="shape" data-aos="fade-right" data-aos-delay="300">
            <img src="/assets/assets/img/images/h5_footer_shape02.svg" alt="shape">
            <img src="/assets/assets/img/images/h5_footer_shape03.svg" alt="shape" class="rotateme">
            <img src="/assets/assets/img/images/h5_footer_shape04.svg" alt="shape" class="alltuchtopdown">
        </div> --}}
    </footer>
    <!-- footer-area-end -->
