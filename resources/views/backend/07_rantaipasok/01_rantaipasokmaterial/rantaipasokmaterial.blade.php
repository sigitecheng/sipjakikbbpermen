...
<!-- Tombol Create -->
<a href="/berantaimaterial/create" style="text-decoration: none;">
...
<td style="text-align: center;">
    ...
    @endif
        ...
        <td style="text-align: center; vertical-align: middle;">
            ...
            <a href="/berantaimaterial/update/{{$item->id}}" class="button-berkas" title="Update">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/berantaimaterial/delete/" + encodeURIComponent(id);
