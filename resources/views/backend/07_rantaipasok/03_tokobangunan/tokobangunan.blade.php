...
<br>
    ...
    <div style="display: flex; align-items: center; gap: 10px;">
        ...
        <select name="informasirantaipasok_id"
                ...
                class="form-select"
                style="width: 250px;">
            <option value="all">Semua Toko Bangunan</option>
        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Bahan ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
                        ...
                        <script>
                            ...
                            fetch(`/berantaiperalatan?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_rantaitokobangunan')"
class="button-berkas"
>
...
<!-- Tombol Create -->
<a href="/betokobangunan/create" style="text-decoration: none;">
...
<th style="width: 120px; text-align:center;">
 ...
 <tbody id="tableBody">
    ...
    $gambar = $item->gambar ?: '/assets/icon/tokobangunan.png';
@endphp
