                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <!-- User ID (Hidden) -->
                                                ...
                                                <div class="form-modern mb-3">
                                                    <label class="form-label-modern-modern" for="user_id">
                                                        <i class="bi bi-person" style="margin-right: 8px; color: navy;"></i> Administrator
                                                    </label>
                                                    <input type="text" id="user_id" class="form-control" value="{{ $user->name }}" disabled>
                                                </div>

                                        <div class="form-modern mb-3">
                                            <label class="form-label-modern-modern" for="asosiasimasjaki_id">
                                        ...
                                        <!-- Nama Lengkap -->
                                        <div class="form-modern mb-3">
                                            <label class="form-label-modern-modern" for="namalengkap">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-modern mb-3">
                                            <label class="form-label-modern" for="tanggal">
                                                <i class="bi bi-calendar" style="margin-right: 8px; color: navy;"></i> Tanggal Pengesahan BUJK
                                            </label>
