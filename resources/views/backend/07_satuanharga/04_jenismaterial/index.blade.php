        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Jenis Material ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
                        ...
                        <script>
                            ...
                            fetch(`/bejenismaterial?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_jenisbahanmaterial')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/bejenismaterial/create">
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
        ...
        <td style="text-align: center; vertical-align: middle;">
            ...
            {{-- <a href="/besatuanhargaperalatan/update/{{$item->id}}" class="button-berkas" title="Update">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bejenismaterial/delete/" + encodeURIComponent(id);
