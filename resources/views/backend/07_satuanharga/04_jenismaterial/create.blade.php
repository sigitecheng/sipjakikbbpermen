  ...
  <button class="button-modern">
    ...
    Kembali
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('create.jenismaterial') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
    ...
    <div class="form-modern mb-3">
        <label class="form-label-modern" for="material">
            <i class="bi bi-card-text" style="margin-right: 8px; color: navy;"></i> Material
        </label>
