...
<section style="background: #FFFFFF; width: 100%; min-height: 100vh;">
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('create.dokberitakegiatan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
    <div class="col-md-12">
        ...
        <div class="form-modern mb-3">
            <label class="form-label-modern" for="kegiatanjaskon_id">
                <i class="bi bi-list-check" style="margin-right: 8px; color: navy;"></i> Pilih Kegiatan
            </label>
            <select id="kegiatanjaskon_id" name="kegiatanjaskon_id"
                ...
                @foreach($kegiatan as $k)
                    <option value="{{ $k->id }}"
                        {{ old('kegiatanjaskon_id', $data->kegiatanjaskon_id ?? '') == $k->id ? 'selected' : '' }}>
                        {{ $k->judul_kegiatan }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-modern mb-3">
            <label class="form-label-modern">
                <i class="bi bi-journal-text" style="margin-right: 8px; color: navy;"></i> Keterangan Berita
            </label>
            <textarea name="keterangan_berita" rows="4"
                      class="form-control @error('keterangan_berita') is-invalid @enderror">{{ old('keterangan_berita', $data->keterangan_berita ?? '') }}</textarea>
        ...
        <div class="form-modern mb-3">
            <label class="form-label-modern">
                <i class="bi bi-image" style="margin-right: 8px; color: navy;"></i> Gambar Berita
            </label>
            ...
            <img id="previewGambar"
                 src="{{ isset($data->gambar) ? asset($data->gambar) : '#' }}"
                 style="max-height:200px; margin-top:10px; {{ isset($data->gambar) ? '' : 'display:none' }}">
        </div>
