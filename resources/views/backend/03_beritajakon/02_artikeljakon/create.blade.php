    ...
    <div class="col-md-6">
        ...
        <div class="form-modern mb-3">
            <label class="form-label-modern" for="user_id">
                <i class="bi bi-person" style="margin-right: 8px; color: navy;"></i> Penulis Artikel
            </label>
...
<div class="form-modern mb-3">
            <label class="form-label-modern" for="berkas">
                <i class="bi bi-file-earmark-pdf" style="margin-right: 8px; color: red;"></i> Berkas Artikel Jakon (PDF)
            </label>
            ...
            <!-- Preview PDF -->
            <div class="mt-2">
                <iframe id="previewBerkas" src="{{ old('berkas') ? asset('storage/' . old('berkas')) : '' }}" style="width:100%; max-height:400px; border:1px solid #ccc;" frameborder="0"></iframe>
            </div>
...
<!-- End Row -->
    ...
    <!-- Ikon Plus -->
                            ...
                            <span style="font-family: 'Poppins', sans-serif;">Tambah Artikel</span>
                        </button>
