        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/suratedaran?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_suratedaranmenteri')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/permensuratedaran/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/suratedaran/delete/" + encodeURIComponent(id);
