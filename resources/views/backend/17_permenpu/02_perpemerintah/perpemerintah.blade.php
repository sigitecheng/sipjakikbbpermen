        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/permenpemerintah?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_perturanpemerintah')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/permenpemerintah/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/perpemerintah/delete/" + encodeURIComponent(id);
