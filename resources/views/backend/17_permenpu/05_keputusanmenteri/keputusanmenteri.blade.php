        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/keputusanmenteri?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_peraturanmenteri')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/keputusanmenteri/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/keputusanmenteri/delete/" + encodeURIComponent(id);
