        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/permengubernur?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_peraturangubernur')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/permengubernur/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/permengubernur/delete/" + encodeURIComponent(id);
