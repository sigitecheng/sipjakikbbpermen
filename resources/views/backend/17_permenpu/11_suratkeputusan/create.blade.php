  ...
  <button class="button-modern">
    ...
    Kembali
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('create.permensuratkeputusannew') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                            <div class="row">
    ...
    <div class="col-md-6">
        <div class="form-modern mb-3">
            <label class="form-label-modern" for="judul">
                <i class="bi bi-card-text" style="margin-right: 8px; color: navy;"></i>
                Judul
            </label>
            <input type="text"
                   id="judul"
...
<div class="row">
    <div class="col-12">
        <div id="pdfPreviewWrapper" style="display:none; margin-top:10px;">
...
function previewPDF(input) {
    ...
    const previewWrapper = document.getElementById('pdfPreviewWrapper');
