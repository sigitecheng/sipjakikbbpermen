        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/permensuratkeputusan?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_suratkeputusanjasakonstruksi')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/permensuratkeputusan/create">
...
<th style="width: 500px; text-align:center;">
  <i class="bi bi-card-text"></i> Berkas
</th>
...
<th style="width: 120px; text-align:center;">
 ...
 <tbody id="tableBody">
    ...
    @php
        ...
        $words = preg_split('/\s+/', $text); // pecah semua jenis spasi
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/permensuratkeputusan/delete/" + encodeURIComponent(id);
