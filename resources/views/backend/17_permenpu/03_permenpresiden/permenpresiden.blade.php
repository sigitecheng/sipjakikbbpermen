        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/permenpresiden?search=${input}`)
...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_peraturanpresiden')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/permenpresiden/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/permenpemerintah/delete/" + encodeURIComponent(id);
