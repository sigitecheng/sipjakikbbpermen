...
<button onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_referensiperaturan')" class="button-berkas">
    <i class="bi bi-download"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/tambahreferensi/create">
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/referensi/delete/" + encodeURIComponent(id);
