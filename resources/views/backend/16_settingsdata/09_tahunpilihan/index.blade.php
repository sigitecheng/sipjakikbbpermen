    ...
    <i class="bi bi-search"
       style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 16px; color: #888;"></i>
                        ...
                        <script>
                            ...
                            fetch(`/settingstahun?search=${input}`)
...
<a href="/sumberdana/create">
    <button class="button-modern">
        <i class="fa fa-plus" style="margin-right: 8px;"></i> Tambah Tahun
    </button>
</a>
...
<i class="bi bi-cash-stack"></i> Tahun Pelaksanaan
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/tahunpilihan/delete/" + encodeURIComponent(id);
