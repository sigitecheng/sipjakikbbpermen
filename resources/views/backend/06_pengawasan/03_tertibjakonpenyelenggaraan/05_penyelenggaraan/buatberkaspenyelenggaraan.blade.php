                                    ...
                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                        <div class="modal-content" style="font-size: 0.875rem;">
                                            <div class="modal-header d-flex align-items-center">
                                                ...
                                                <p style="margin-left: 10px; font-size: 0.9rem; margin-bottom: 0;">Dinas Pekerjaan Umum Dan Tata Ruang Kabupaten Blora</p>
                            ...
                            <input type="hidden"  name="tertibjakonpenyelenggaraan_id" value="{{ $datatertibjasakonstruksi_id }}">
                                ...
                                <div class="modal-content" style="font-size: 0.875rem;">
                                    <div class="modal-header d-flex align-items-center">
                                        ...
                                        <span class="mx-2">:</span>
                                        <p style="margin-left: 10px; margin-bottom: 0; font-size:15px;">Dinas Pekerjaan Umum Dan Tata Ruang Kabupaten Blora</p>
                                    </div>
                                    <br>
                                    <div class="modal-body">
