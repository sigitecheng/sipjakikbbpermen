...
return new class extends Migration
{
    ...
    {
        Schema::create('divuraianbahanperalatans', function (Blueprint $table) {
            $table->id();
              $table->foreignId('ahspdiv1_id')->nullable();
            $table->foreignId('satuanhargaperalatan_id')->nullable();
    ...
    {
        Schema::dropIfExists('divuraianbahanperalatans');
    }
};
