...
return new class extends Migration
{
    ...
    {
        Schema::create('divuraianbahanmaterials', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ahspdiv1_id')->nullable();
            $table->foreignId('satuanhargamaterial_id')->nullable();
    ...
    {
        Schema::dropIfExists('divuraianbahanmaterials');
    }
};
